...
<picture>
  ...
  <img alt="Projects" src="./assets/section-projects-light.svg" width="480">
</picture>
...
<p align="center">
  <picture>
    ...
    <img alt="OTA Pulse: Android OTA update utility focused on a clean and simple update experience." src="./assets/card-otapulse-light.svg" width="49%">
  </picture>
  <picture>
    ...
    <img alt="Link Resolver: Android utility for resolving and handling download links." src="./assets/card-linkresolver-light.svg" width="49%">
  </picture>
  <br/>
  <picture>
    ...
    <img alt="ROM Development: custom ROM ports, system modifications, optimization and device bring-up." src="./assets/card-rom-light.svg" width="49%">
  </picture>
  <picture>
    ...
    <img alt="Kernel Development: Android/Linux kernel experimentation, optimization and device support." src="./assets/card-kernel-light.svg" width="49%">
  </picture>
</p>
...
<picture>
  ...
  <img alt="Animated heartbeat line: thanks for stopping by" src="./assets/footer-light.svg" width="100%">
</picture>
